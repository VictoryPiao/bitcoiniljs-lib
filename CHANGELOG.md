...
# 2.0.0
In this release we have strived to simplify the API,  [using native types](https://github.com/top1st/bitcoiniljs-lib/issues/407) wherevever possible to encourage cross-compatibility with other open source community modules.
...
__added__
- export `address`, for `address` based [utility functions](https://github.com/top1st/bitcoiniljs-lib/blob/master/src/address.js), most compatible, just without `Address` instantiation, see #401, #444
- export `script`, for `script` based [utility functions](https://github.com/top1st/bitcoiniljs-lib/blob/master/src/script.js), mostly compatible, just without `Script` instantiation, see #438, #444
...
- `networks.*.magic`, see the comment [here](https://github.com/top1st/bitcoiniljs-lib/pull/432/files#r36715792)
